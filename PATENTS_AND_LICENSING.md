...
## 1. Relación con Publicación de Zenodo
...
**Este Repositorio:**
- Propósito: Implementación de referencia y documentación complementaria
- Estado: Suplementario, no sustitutivo
- Efecto: Fortalece el prior art existente
...
|--------|-----------|---------------|
| Lectura y estudio | ✅ Sí | Ninguna |
| Uso no comercial | ✅ Sí | Solo fines educativos/de investigación |
...
Esta licencia se aplica a TODO el contenido de este repositorio EXCEPTO lo expresamente indicado en la Sección 4.
...
## 4. Excepciones y Términos Especiales

### 4.1 Código de Implementación vs. Documentación

**Documentación (README, docs/, etc.):**
- Licencia: CC BY-NC 4.0
- Uso: Académico y no comercial permitido

**Código Fuente (src/, examples/, etc.):**
- Licencia: CC BY-NC 4.0 para referencia
- Uso: Sujeto a restricciones de patente adicionales
- Implementación: Requiere autorización para uso comercial

### 4.2 Proyectos de Investigación Académica

Las instituciones académicas PUEDEN:
- Usar el código para investigación no comercial
- Enseñar con los materiales
- Publicar resultados de investigación (con atribución)
...
## 5. Protección de Prior Art

### 5.1 Evidencia de Prior Art

Este repositorio, junto con la publicación de Zenodo, constituye:

1. **Evidencia de concepción:** Demuestra que las ideas existían en la fecha de publicación
2. **Evidencia de reducción a práctica:** El código demuestra implementación funcional
3. **Publicación anticipatoria:** Previene que otros patenten las mismas invenciones

### 5.2 Fecha de Prior Art

La fecha de prior art se establece por:
1. **Zenodo:** 23 de enero de 2026 (DOI registrado)
2. **GitHub:** Fecha de primer commit público
3. **Consistencia:** El contenido de GitHub debe ser consistente con Zenodo

### 5.3 Advertencias

**NO hacer:**
- ❌ Modificar la invención de manera que sugiera autoría propia
- ❌ Presentar el código como si fuera de tu invención
- ❌ Usar para crear productos comerciales
- ❌ Licenciar a terceros sin autorización

**SÍ hacer:**
- ✅ Estudiar y aprender de la implementación
- ✅ Referenciar en investigación académica
- ✅ Crear mejoras para contribución (bajo los términos de contribución)
- ✅ Citar apropiadamente en publicaciones

---

## 6. Términos de Contribución

Cuando contribuyes a este repositorio:
...
ESTE REPOSITORIO SE PROPORCIONA "TAL CUAL" SIN GARANTÍAS DE NINGÚN TIPO, EXPRESAS O IMPLÍCITAS, INCLUYENDO PERO NO LIMITADO A GARANTÍAS DE COMERCIALIZACIÓN, ADECUACIÓN PARA UN PROPÓSITO PARTICULAR, Y NO VIOLACIÓN.
...
- Cuestiones legales
- Reportar violaciones de propiedad intelectual

---

## 10. Ley Aplicable

Este documento y el uso de este repositorio se rigen por:
- Ley de propiedad intelectual aplicable
- Tratados internacionales (PCT, etc.)
